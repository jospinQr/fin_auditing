...
import 'dart:io';
import 'package:fin_auditing/Public/Views/Pages/ConnectionFaildPage.dart';
...
class _SplashViewState extends State<SplashView> {
  ...
  Future<void> CheckUserConnection() async {
    ...
    try{
       var response=await http.get(Uri.parse(publicConst.AipConstants.baseUrl));
  ...
  Widget build(BuildContext context) {
    return SplashScreen(
      ...
      navigateAfterSeconds:estConnecter==true ?  const LoginPage():const connectionFail(),
      useLoader: true,
      photoSize: 100,
      title: const Text(
        "par SpeedSoftIt",
